...
function preload() {
  mic = loadImage('data/Rachel_data/mic.png');        //  load mic image
  floor = loadImage('data/Rachel_data/floor.png');    //  load floor image
  lights = loadImage('data/Rachel_data/lights.png');  //  load light image
